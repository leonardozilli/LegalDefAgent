...
from legisdefagent.api.service import app
...
def mock_agent():
    ...
    with patch("legisdefagent.api.service.get_agent", Mock(return_value=agent_mock)):
        yield agent_mock
...
def mock_settings(mock_env):
    ...
    with patch("legisdefagent.api.service.settings") as mock_settings:
        yield mock_settings
